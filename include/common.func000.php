...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg = $func;
        $rmsg .= "document.write(\"<style type='text/css'>#errorbox{border:#CCCCCC 1px dashed; width:400px; margin:30px auto; line-height:25px; background:#FFF;}#errortitle{height:30px; font-weight:bold; background-color:#CCCCCC; padding-left:10px;}#errorinfo{height:100px; padding:10px 10px;}#errorlink{height:30px; text-align:center;}#indexad1{line-height:25px; width:226px; height:100px; overflow:hidden; margin-left:10px;}#indexad2{ padding:0; margin:0;}#indexad3{lint-height:25px; width:160px; height:100px; margin-left:40px;}}</style>\");\r\n";
        $rmsg .= "document.write(\"<div id='errorbox'>\");\r\n";
		$rmsg .= "document.write(\"<div id='errortitle'>系统信息</div>\");\r\n";
		$rmsg .= "document.write(\"<div id='errorinfo'>\");\r\n";		
