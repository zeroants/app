...
(function(i) {
    ...
    function k(y, J, u, t, E) {
        ...
        if (C.next) {
            i(C.next).bind(C.prevNextEvent,
            function() {
                return o(C, C.rev ? -1 : 1)
            })
        }
        if (C.prev) {
            i(C.prev).bind(C.prevNextEvent,
            function() {
                return o(C, C.rev ? 1 : -1)
            })
        }
    ...
    i.fn.cycle.resetState = function(r, q) {
        ...
        r.original.animOut);
        r.fxFn = null;
        i.each(r.original.before,
        function() {
            r.before.push(this)
        });
        i.each(r.original.after,
        function() {
            r.after.push(this)
        });
...
(function(a) {
    ...
    a.fn.cycle.transitions.shuffle = function(e, f, d) {
        ...
        d.fxFn = function(m, j, l, g, i) {
            ...
            a(j).css(l.cssBefore);
            var k = l.slideCount;
            h.animate(l.shuffle, l.speedIn, l.easeIn,
            function() {
